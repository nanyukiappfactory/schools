...
<div class="form-group ">
    ...
    <input type="text" class="form-control" id="school_name" aria-describedby="emailHelp" name="school_name"
		...
		value="<?php echo set_value('school_name', $this->session->flashdata('form_inputs')['school_name']); ?>">
</div>
<div class="form-group">
	<label for="school_zone">Zone</label>
	<select id="inputState" class="form-control" name="school_zone">
		<option selected><?php echo set_value('school_zone',     $this->session->flashdata('form_inputs')['school_zone']); ?>
		</option>
...
<div class="form-group">
            ...
            <div class="col-sm-10 row">
                <div class="form-check">
                    <input class="form-check-input" type="radio" name="school_status"style="margin-top:15px;" id="school_status" value="1"checked>
                    <Legend class="form-check-label" for="gridRadios1"style="padding-right:25px;">
                        Active
                    </Legend>
                </div>
                <div class="form-check">
                    <input class="form-check-input" type="radio" name="school_status" style="margin-top:15px"; id="school_status" value="0">
...
<div class="form-group row">
	<div class="col-sm-12 col-md-12">
		<label for="school_image">Profile Image</label>
