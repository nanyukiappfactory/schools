...
if ($query->num_rows() > 0)
 {
  ...
  ?>
	...
	<div class="form-group row">
		<label for="school_zone" class="col-sm-2 col-form-label">School Zone</label>
		<div class="col-md-10">
	...
	<div class="form-group row">
		...
		<label for="school_girls_number" class="col-sm-2 col-form-label">Upload New Image</label>
		<div class="col-md-10">
	...
	<div class="form-group">
		...
		<div class="col-md-10">
				<input type="radio" name="school_status" value="1"
				<?php echo set_value('school_status', $row->school_status) == 1 ? "checked" : "";?> />Active
				<input type="radio" name="school_status" value="0" 
				<?php echo set_value('school_status', $row->school_status) == 0 ? "checked" : "";?> />Inactive
		</div>
		<small id="emailHelp" class="form-text text-muted"></small>
	</div>
	<div class=" form-group">
				<label for="school_write_up">School Write Up</label>
				<textarea id="editable" class="editable" name="school_write_up"><?php echo set_value('school_write_up', $row->school_write_up); ?></textarea>
				<div class="form-group">
					<small id="emailHelp" class="form-text text-muted"></small>
				</div>
	</div>
	<div class="form-group row">
		<div class="col-sm-10">
			<div class="modal-footer">
				...
				<button type="submit" class="btn btn-primary"><i class="fas fa-check"></i>Save School
				</button>
			</div>
		</div>
	</div>
