...
<input type="user_name" style="margin-bottom:40px;" id="user_name" name="user_name" class="form-control"
    placeholder="Username" required autofocus>
<label for="user_password" class="sr-only">Password</label>
<input type="password" style="margin-bottom:40px;" id="user_password" name="user_password" class="form-control"
