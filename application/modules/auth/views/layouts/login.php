...
<?php echo form_open($this->uri->uri_string(), array("class" => "form-signin","style"=>"padding:20px;background-color:#259dbb;border-radius:5px;"));?>
	...
	<input type="text" style="margin-bottom:40px;" id="user_name" name="user_name" class="form-control" value="<?php echo set_value('user_name', $this->session->flashdata('form_inputs')['user_name']); ?>" placeholder="Username">
	<label for="user_password" class="sr-only">Password</label>
	<input type="password" style="margin-bottom:40px;" id="user_password"  name="user_password" value="<?php echo set_value('user_password', $this->session->flashdata('form_inputs')['user_password']); ?>"class="form-control" placeholder="Password">
